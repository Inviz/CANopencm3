...
#define CO_CANbitRateDataInitializers                                       \
  {10, TQ_x_20, 10}, {5, TQ_x_20, 20}, {2, TQ_x_20, 50}, {1, TQ_x_16, 125}, \
      {1, TQ_x_8, 250}, {1, TQ_x_8, 0}, {1, TQ_x_8, 0}, {                   \
    1, TQ_x_8, 0                                                            \
  }
#elif CO_FSYS == 8000
#define CO_CANbitRateDataInitializers                                        \
  {25, TQ_x_16, 10}, {10, TQ_x_20, 20}, {5, TQ_x_16, 50}, {2, TQ_x_16, 125}, \
      {1, TQ_x_16, 250}, {1, TQ_x_8, 500}, {1, TQ_x_8, 0}, {                 \
    1, TQ_x_8, 0                                                             \
  }
#elif CO_FSYS == 12000
#define CO_CANbitRateDataInitializers                                        \
  {40, TQ_x_15, 10}, {20, TQ_x_15, 20}, {8, TQ_x_15, 50}, {3, TQ_x_16, 125}, \
      {2, TQ_x_12, 250}, {1, TQ_x_12, 500}, {1, TQ_x_12, 0}, {               \
    1, TQ_x_12, 0                                                            \
  }
#elif CO_FSYS == 16000
#define CO_CANbitRateDataInitializers                                         \
  {50, TQ_x_16, 10}, {25, TQ_x_16, 20}, {10, TQ_x_16, 50}, {4, TQ_x_16, 125}, \
      {2, TQ_x_16, 250}, {1, TQ_x_16, 500}, {1, TQ_x_10, 800}, {              \
    1, TQ_x_8, 1000                                                           \
  }
#elif CO_FSYS == 20000
#define CO_CANbitRateDataInitializers                                         \
  {50, TQ_x_20, 10}, {25, TQ_x_20, 20}, {10, TQ_x_20, 50}, {5, TQ_x_16, 125}, \
      {2, TQ_x_20, 250}, {1, TQ_x_20, 500}, {1, TQ_x_20, 0}, {                \
    1, TQ_x_10, 1000                                                          \
  }
#elif CO_FSYS == 24000
#define CO_CANbitRateDataInitializers                                         \
  {63, TQ_x_19, 10}, {40, TQ_x_15, 20}, {15, TQ_x_16, 50}, {6, TQ_x_16, 125}, \
      {3, TQ_x_16, 250}, {2, TQ_x_12, 500}, {1, TQ_x_15, 800}, {              \
    1, TQ_x_12, 1000                                                          \
  }
#elif CO_FSYS == 32000
#define CO_CANbitRateDataInitializers                                         \
  {64, TQ_x_25, 10}, {50, TQ_x_16, 20}, {20, TQ_x_16, 50}, {8, TQ_x_16, 125}, \
      {4, TQ_x_16, 250}, {2, TQ_x_16, 500}, {2, TQ_x_10, 800}, {              \
    1, TQ_x_16, 1000                                                          \
  }
#elif CO_FSYS == 36000
#define CO_CANbitRateDataInitializers                                         \
  {50, TQ_x_18, 10}, {50, TQ_x_18, 20}, {20, TQ_x_18, 50}, {8, TQ_x_18, 125}, \
      {4, TQ_x_18, 250}, {2, TQ_x_18, 500}, {2, TQ_x_18, 0}, {                \
    1, TQ_x_18, 1000                                                          \
  }
#elif CO_FSYS == 40000
#define CO_CANbitRateDataInitializers                                         \
  {50, TQ_x_20, 0}, {50, TQ_x_20, 20}, {25, TQ_x_16, 50}, {10, TQ_x_16, 125}, \
      {5, TQ_x_16, 250}, {2, TQ_x_20, 500}, {1, TQ_x_25, 800}, {              \
    1, TQ_x_20, 1000                                                          \
  }
#elif CO_FSYS == 48000
#define CO_CANbitRateDataInitializers                                         \
  {63, TQ_x_19, 0}, {63, TQ_x_19, 20}, {30, TQ_x_16, 50}, {12, TQ_x_16, 125}, \
      {6, TQ_x_16, 250}, {3, TQ_x_16, 500}, {2, TQ_x_15, 800}, {              \
    2, TQ_x_12, 1000                                                          \
  }
#elif CO_FSYS == 56000
#define CO_CANbitRateDataInitializers                                         \
  {61, TQ_x_23, 0}, {61, TQ_x_23, 20}, {35, TQ_x_16, 50}, {14, TQ_x_16, 125}, \
      {7, TQ_x_16, 250}, {4, TQ_x_14, 500}, {5, TQ_x_7, 800}, {               \
    2, TQ_x_14, 1000                                                          \
  }
#elif CO_FSYS == 64000
#define CO_CANbitRateDataInitializers                                         \
  {64, TQ_x_25, 0}, {64, TQ_x_25, 20}, {40, TQ_x_16, 50}, {16, TQ_x_16, 125}, \
      {8, TQ_x_16, 250}, {4, TQ_x_16, 500}, {2, TQ_x_20, 800}, {              \
    2, TQ_x_16, 1000                                                          \
  }
#elif CO_FSYS == 72000
#define CO_CANbitRateDataInitializers                                        \
  {40, TQ_x_18, 0}, {40, TQ_x_18, 0}, {40, TQ_x_18, 50}, {16, TQ_x_18, 125}, \
      {8, TQ_x_18, 250}, {4, TQ_x_18, 500}, {3, TQ_x_15, 800}, {             \
    2, TQ_x_18, 1000                                                         \
  }
#elif CO_FSYS == 80000
#define CO_CANbitRateDataInitializers                                        \
  {40, TQ_x_20, 0}, {40, TQ_x_20, 0}, {40, TQ_x_20, 50}, {16, TQ_x_20, 125}, \
      {8, TQ_x_20, 250}, {4, TQ_x_20, 500}, {2, TQ_x_25, 800}, {             \
    2, TQ_x_20, 1000                                                         \
  }
#else
...
const CO_CANbitRateData_t CO_CANbitRateData[] = {CO_CANbitRateDataInitializers};
...
CO_ReturnError_t CO_CANmodule_init(CO_CANmodule_t *CANmodule, void *CANptr,
  ...
  CANmodule->useCANrxFilters =
      false;  //(rxSize <= 32U) ? true : false;/* microcontroller dependent */
  ...
  if (can_init(CANmodule->CANport,  /* Which port to use? */
               ...
               (CANbitRateData->phSeg1 + CANbitRateData->PROP - 1)
                   << CAN_BTR_TS1_SHIFT,
               (CANbitRateData->phSeg2 - 1) << CAN_BTR_TS2_SHIFT,
               CANbitRateData->BRP, false, false) != 0) {
...
CO_ReturnError_t CO_CANsend(CO_CANmodule_t *CANmodule, CO_CANtx_t *buffer) {
  ...
  if (can_transmit(CANmodule->CANport, buffer->ident, false, buffer->rtr,
                   buffer->DLC, buffer->data) != -1) {
...
/* Interrupt called when message was not sent immediately due to
    full TX mailboxes, which now became have space in them.
...
void CO_CANTxInterrupt(CO_CANmodule_t *CANmodule) {
  ...
  if (CANmodule->CANtxCount != 0U) {
    ...
    for (uint16_t i = 0; i < CANmodule->txSize; i++) {
       ...
       * interrupt */
      if (can_transmit(CANmodule->CANport, buffer->ident, false, false,
                       buffer->DLC, buffer->data) == -1)
        return;
